...
public class HUDManager : MonoBehaviour
{
    ...
    private Sprite GetWeaponSprite(Weapon.WeaponModel model)
    {
        switch (model)
        {
            case Weapon.WeaponModel.Heavy:
                return Instantiate(Resources.Load<GameObject>("Heavy_Weapon")).GetComponent<SpriteRenderer>().sprite;
    ...
    private Sprite GetAmmoSprite(Weapon.WeaponModel model)
    {
        ...
        {
            case Weapon.WeaponModel.Heavy:
                return Instantiate(Resources.Load<GameObject>("Heavy_Ammo")).GetComponent<SpriteRenderer>().sprite;
